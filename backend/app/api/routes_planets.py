        ...
        if planet.index == index:
            if sessionmaker is not None:
                try:
                    ...
                    planet.derived = None
                    logger.warning("planet_derived_lookup_failed planet_index=%s error=%r", index, exc)
            return planet
...
async def get_planet_history(
    ...
    try:
        ...
        logger.warning("planet_history_lookup_failed planet_index=%s error=%r", index, exc)
        return PlanetHistoryResponse(history=[])
